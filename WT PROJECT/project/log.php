        ...
        if(mysqli_connect_errno()){
            ...
            if(mysqli_error($con)){
                ...
                if($row=mysqli_fetch_assoc($res)){
                    if($pwd!=$row['password']){
                        $output.="<p>Incorrect Password!</p><div class='btn'><a href='login.html'><button>Go Back</button></a></div>";
                    }else{
                        $output.="<p>Login Successful!</p><div class='btn'><a href='home.html'><button>Proceed</button></a></div>";
                    }
                }else{
